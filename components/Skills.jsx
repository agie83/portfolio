...
function Skills() {
  ...
  //   Photoshop`;
  const skillList =
    "html,css,sass,tailwind,javascript,react,nextjs,node,mongo,firebase,php,mySQL,github,photoshop,figma";
  ...
  return (
    <div id="skills" className="container w-full md:h-screen p-2">
      <div className="flex flex-col justify-center max-w-[1240px] h-full mx-auto py-8 pt-20 md:py-16 md:pt-20">
        <p className="text-xl tracking-widest uppercase text-main-color">
          Skills
        </p>
